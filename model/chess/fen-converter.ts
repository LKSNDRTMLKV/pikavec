import { Color, LastMove, columns } from "@/interface/chess-props";
import Piece from "./piece";
import King from "./king";
import Rook from "./rook";
import Pawn from "./pawn";

export default class FENConverter {
    ...
    private enPassantPosibility(lastMove: LastMove | null, color: Color): string {
        if (!lastMove) return "-";
