...
const CompatibilityForm: React.FC<DailyFormProps> = ({
    ...
    const form = useForm({
        ...
        defaultValues: {
            ...
            horoscopeId: initialData?.horoscopeId ?? '',
            story: initialData?.story ?? "",
            date: initialData?.date ?? new Date(),
            familyDescription: initialData?.familyDescription ?? "",
            familyRating: initialData?.familyRating ?? 0,
            loveDescription: initialData?.loveDescription ?? "",
            loveRating: initialData?.loveRating ?? 0,
            healthDescription: initialData?.healthDescription ?? "",
            healthRating: initialData?.healthRating ?? 0,
            careerDescription: initialData?.careerDescription ?? "",
            careerRating: initialData?.careerRating ?? 0,
            friendshipDescription: initialData?.friendshipDescription ?? "",
            friendshipRating: initialData?.friendshipRating ?? 0,
            moneyDescription: initialData?.moneyDescription ?? "",
            moneyRating: initialData?.moneyRating ?? 0,
            happinessDescription: initialData?.happinessDescription ?? "",
            happinessRating: initialData?.happinessRating ?? 0,
            travelDescription: initialData?.travelDescription ?? "",
            travelRating: initialData?.travelRating ?? 0,
        }
    })
            ...
            <div className=' w-full p-4'>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(handleSubmit)} className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Textarea
                                                className='min-h-32 md:min-h-24'
                                                disabled={loading}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Textarea
                                                className='min-h-24 md:min-h-20'
                                                disabled={loading}
                        ...
                        <div className='flex col-span-2 w-full my-2 justify-end gap-4 items-center'>
                            {initialData ?
