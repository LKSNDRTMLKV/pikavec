...
const UsersHeaderNavbar = () => {
    const pathname = usePathname();

    const [usersNavbarList, setUsersNavbarList] = React.useState<HeaderNavbarProps[]>([
        {
            label: 'Insights',
    ...
    React.useEffect(() => {
        setUsersNavbarList(prevList => prevList.map(navItem => {
    ...
    return (
        <HeaderNavbar headerNavbarList={usersNavbarList} />
    )
}

export default UsersHeaderNavbar;