...
const DashboardHeaderNavbar = () => {
    ...
    const [dashboardNavbarList, setDashboardNavbarList] = React.useState<HeaderNavbarProps[]>([
        {
            label: 'Insights',
    ...
    React.useEffect(() => {
        setDashboardNavbarList(prevList => prevList.map(navItem => {
    ...
    return (
        <HeaderNavbar headerNavbarList={dashboardNavbarList} />
    )
}
